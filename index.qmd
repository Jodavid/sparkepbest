...
format:
  revealjs:
    ...
    css: ["css/jodavid.css"]
    theme: default
    footer: "<https://jodavid.github.io/sparkepbest/> - [Jodavid Ferreira](https://jodavid.github.io/)"
...
<hr/>
<h1 style="text-align:center;">Introdução ao SPARK</h1>
<hr/>
...
<div style="text-align: center;">
![](images/1_b-X6jefi9190lQaH33KkDA.webp){.relative width=500}
</div>
...
<hr/>
<h1 style="text-align:center;">Apache Spark</h1>
<hr/>
...
dados <- spark_read_parquet(spark_conn,
          name = "../dados/base_e-commerce_parquet/database_compras_parquet.parquet" )
```
...
# -----------------
dados = spark.read.parquet("../dados/base_e-commerce_parquet/database_compras_parquet.parquet")
```
